  ...
  return (
    <div className={styles.profile__body}>
      <div className={styles.profile__top__container}>
        <span className={styles.LeftArrow}><ArrowLeft /></span>
      ...
      <div>
        ...
        <div className={styles.profile__pic}>
          <img className={styles.profile__pic__img} src='https://loveshayariimages.in/wp-content/uploads/2021/10/1080p-Latest-Whatsapp-Profile-Images-1.jpg' />
      ...
      <div className={styles.bio__full__details}>
        <div className={styles.bio__details}>
          <span className={styles.bio__user__name}>Ritik Diyundi</span>
          <span className={styles.bio__user__id}>@hritikdiyundi</span>

          <span className={styles.bio__user__bio}>Everything is fine</span>
          <div className={styles.bio__user__joined}>
            <CalenderIcon />
            <span className={styles.bio__user__hbd__text}>Born Jan 1, 2000</span>
          {/* <div className={styles.bio__user__joined}> */}
            <CalenderIcon />
            <span className={styles.bio__user__joined__text}>Joined 1-12-2019</span>
          </div>
