  ...
  return (
    <div className={styles.header__container}>
      ...
      <div className={styles.header__middle}>
        <Image className={styles.header__user__image} src={'/one.jpg'} alt="dp_" height={50} width={50} />
        <input
          type="text"
      ...
      <div className={styles.header__icons__with__button}>
        ...
        <button disabled={true} className={styles.header__tweet__button} type="submit">
          Tweet
        </button>
      </div>
    </div>
